<x-user.dashboard-layout>
    ...
    <div class="space-y-8">
        ...
        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col lg:flex-row gap-8">
                        ...
                        <div class="flex flex-col items-center lg:items-start">
                            <div class="relative group w-[200px] h-[200px] rounded-full overflow-hidden shadow-lg border-4 border-white ring-2 ring-[#0F044C]/10">
                                ...
                                <div class="absolute inset-0 bg-gradient-to-br from-[#1D2C90]/80 to-[#0F044C]/80 opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center transition-all duration-300 cursor-pointer rounded-full" onclick="document.getElementById('profile_photo_input').click()">
                            ...
                            <p class="text-xs defparagraf text-gray-600 mt-3 text-center lg:text-left px-2">Bergabung pada {{ $profileData['join_date'] }}</p>
                            @error('profile_photo')
                        ...
                        <div class="flex-1 space-y-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="nama" value="{{ $profileData['nama'] }}" 
                            ...
                            <div>
                                ...
                                <p class="text-xs defparagraf text-gray-600 mt-2 px-1">Email terlihat sebagai: <span class="font-medium">{{ $profileData['masked_email'] }}</span></p>
                            </div>
                            ...
                            <div>
                                <label class="block text-sm font-semibold defparagraf text-[#0F044C] mb-2.5">Konfirmasi Password</label>
                                <div class="relative">
            ...
            <div class="bg-white border border-[#0F044C]/20 shadow-md rounded-2xl p-6 sm:p-8 mb-6">
                <div class="space-y-6 sm:space-y-8">
                    <h2 class="sm:text-xl md:text-xl lg:text-2xl font-montserrat-48 text-gray-900 font-bold flex items-center space-x-2">
                        <svg class="w-6 h-6 text-[#1D2C90]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                        </svg>
                        <span>DETAIL MENGENAI PROFIL ANDA</span>
                    </h2>
                    
                    <div class="space-y-5">
                        <!-- WhatsApp Number Field -->
                        <div>
                            <label class="block text-sm font-semibold defparagraf text-[#0F044C] mb-2.5">Nomor WhatsApp</label>
                            <div class="relative">
                                <input type="tel" name="no_wa" value="{{ $profileData['no_wa'] }}" 
                                       placeholder="+62 81234567890" 
                                       class="w-full h-12 px-4 py-2 pl-11 border border-[#0F044C]/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1D2C90]/30 focus:border-[#1D2C90] defparagraf text-gray-900 placeholder-gray-400 transition-all duration-200 bg-white">
                        ...
                        <!-- Address Field -->
                        <div>
                            <label class="block text-sm font-semibold defparagraf text-[#0F044C] mb-2.5">Alamat Anda</label>
                            <div class="relative">
                                <textarea name="alamat" rows="4" 
                                          placeholder="Masukkan alamat lengkap Anda" 
                                          class="w-full px-4 py-3 border border-[#0F044C]/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1D2C90]/30 focus:border-[#1D2C90] defparagraf text-gray-900 placeholder-gray-400 transition-all duration-200 resize-none bg-white">{{ $profileData['alamat'] }}</textarea>
                                @error('alamat')
                                    <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
                                @enderror
                            </div>
