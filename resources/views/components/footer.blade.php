<footer class="bg-[#0F044C] text-white">
	<div class="mx-auto py-16 px-16 sm:px-20 lg:px-24">
		<div class="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
			...
			<div>
				<h4 class="bigparagraf mb-4 text-bold">Quick Links</h4>
				<ul class="space-y-3 defparagraf">
					<li><a href="/" class="hover:underline">Beranda</a></li>
					<li><a href="/layanan" class="hover:underline">Layanan</a></li>
					<li><a href="/#antrian" class="hover:underline">Antrian</a></li>
			...
			<!-- Column 3: Social -->
			<div>
				<h4 class="bigparagraf mb-4">Sosial Media</h4>
				<ul class="space-y-3 defparagraf">
	...
	<div class="border-t border-white/10">
		<div class="mx-auto max-w-7xl px-6 lg:px-8 py-4">
			<p class="text-center text-sm text-white/80">© 2025 DWI AC MOBIL. All rights reserved</p>
		</div>
	</div>
</footer>
