<!-- Sidebar Component -->
<aside class="w-[300px] lg:w-[300px] md:w-[280px] sm:w-[280px] bg-[#EEEEEE] min-h-screen fixed left-0 top-0 z-40 transition-all duration-300 ease-in-out transform lg:translate-x-0 md:translate-x-0 sm:-translate-x-full">
