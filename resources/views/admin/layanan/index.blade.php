    ...
    <div class="space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-12">
        ...
        <div class="mb-6 sm:mb-8 md:mb-10 lg:mb-12">
            <div class="flex justify-between items-start">
                ...
                <a href="{{ route('admin.layanan.create') }}" class="bg-[#141E61] hover:bg-[#0F044C] text-white px-6 py-3 defparagraf font-medium flex items-center space-x-2 transition-colors rounded-sm">
