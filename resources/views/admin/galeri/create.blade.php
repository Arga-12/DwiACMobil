                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="judul" value="{{ old('judul') }}" placeholder="Masukkan judul galeri" class="w-full px-4 py-3 border border-gray-300 focus:ring-2 focus:ring-[#3B2A7A] focus:border-transparent transition-colors @error('judul') border-red-500 @enderror" required>
                                    @error('judul')
                                ...
                                <div>
                                    ...
                                    <select name="kategori" class="w-full px-4 py-3 border border-gray-300 focus:ring-2 focus:ring-[#3B2A7A] focus:border-transparent transition-colors @error('kategori') border-red-500 @enderror" required>
                                        ...
                                        <option value="before-after" {{ old('kategori') == 'before-after' ? 'selected' : '' }}>Before After</option>
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi" placeholder="Masukkan deskripsi galeri (opsional)" rows="4" class="w-full px-4 py-3 border border-gray-300 focus:ring-2 focus:ring-[#3B2A7A] focus:border-transparent transition-colors resize-none @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-1">
                                        <input type="file" name="gambar" accept="image/*" class="w-full px-4 py-3 border border-gray-300 focus:ring-2 focus:ring-[#3B2A7A] focus:border-transparent transition-colors @error('gambar') border-red-500 @enderror" onchange="previewImage(this)" required>
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="w-4 h-4 text-[#3B2A7A] border-gray-300 focus:ring-[#3B2A7A]">
